...
areas = (function() {
    ...
    // probably never contiguous: [63]
  {
     ...
     monsterMove: monsterMoveErraticCoward(0.1, [0, 2]), // TODO
    ...
    // probably never contiguous: [62]
  {
     ...
     obstacleColor: "#09f",
     obstacleBold: "normal",
     obstacleMsg: "You cannot walk in the <span class='areaName'>water</span>!",
    ...
    // probably never contiguous: [61]
  {
     ...
     monsterMove: monsterMoveErraticCoward(-1, [0, 2, 5, 7]), // TODO
    ...
    // probably never contiguous: [60]
  {
     ...
     obstacle: "\u0448",
     obstacleColor: "#00cc7a",
     obstacleBold: "normal",
     obstacleMsg: "You cannot walk on this <span class='obstacleName'>bush</span>!",
     obstacleElement: ["vegetal"],
     ...
     monsterColor: "#008080",
     monsterBold: "normal",
     monsterMsg: "The <span class='monsterName'>giant eel</span> would kill you!",
    ...
    // probably never contiguous: [56]
  {
     ...
     obstacleColor: "#884",
     obstacleBold: "normal",
     obstacleMsg: "You cannot walk in this <span class='obstacleName'>swampy ditch</span>!",
     obstacleElement: ["water"],
     obstacleFrequency: 5,
     monster: "s",
     // monsterName: "large snake",
     monsterColor: "#aa5",
     monsterBold: "normal",
     monsterMsg: "The <span class='monsterName'>large snake</span> would kill you!",
     monsterKill: "You killed the <span class='monsterName'>large snake</span>!",
     monsterElement: ["animal", "snake"],
     monsterProbability: basicProbability(0.075),
     monsterMove: monsterMoveErraticCoward(-1, [2, 7]), // TODO
     monsterDeath: "You were killed by a <span class='monsterName'>large snake</span>!",
     item: "\u25ca",
     itemColor: "#86b300",
     itemBold: "normal",
     itemName: "Sign of Dark Water",
    ...
    // probably never contiguous: [50]
  {
     ...
     obstacleColor: "#c00",
     obstacleBold: "normal",
     obstacleMsg: "You cannot walk on this <span class='areaName'>boiling lava</span>!",
     obstacleElement: ["unwalkable"],
     obstacleFrequency: 1,
     monster: "",
     // monsterName: "lava",
    ...
    // probably never contiguous: [48]
  {
     ...
     obstacleColor: "#606",
     obstacleBold: "normal",
     obstacleMsg: "The <span class='areaName'>poisoned vapors</span> would kill you!",
     obstacleElement: ["unwalkable"],
     obstacleFrequency: 0,
     monster: "\u2248", // two waves
     // monsterName: "",
     monsterColor: "#606",
     monsterBold: "normal",
     monsterMsg: "The <span class='areaName'>poisoned vapors</span> would kill you!",
     monsterKill: "",
     monsterElement: ["unwalkable"],
     monsterProbability: function(G, c) { return 2; },
     monsterMove: function(G, c, tx, ty) { return [c.x, c.y]; },
     monsterDeath: "You were killed by <span class='monsterName'>poisoned vapors</span>!",
     item: "\u2248",
     itemColor: "#606",
     itemBold: "normal",
     itemName: "",
